...
describe("axolotl-crypto", function() {
    ...
    describe("calculateAgreement", function() {
        it("calculates an agreement", function() {
            var keyPair1 = axolotlCrypto.generateKeyPair();
            var keyPair2 = axolotlCrypto.generateKeyPair();
            var secret1 = axolotlCrypto.calculateAgreement(keyPair1.public, keyPair2.private);
            var secret2 = axolotlCrypto.calculateAgreement(keyPair2.public, keyPair1.private);
        ...
        it("computes the correct shared secret", function() {
            ...
            var actualShared1 = axolotlCrypto.calculateAgreement(alicePublic, bobPrivate);
            var actualShared2 = axolotlCrypto.calculateAgreement(bobPublic, alicePrivate);
    ...
    describe("verifySignature", function() {
        it("returns true for a valid signature", function() {
            assert.ok(axolotlCrypto.verifySignature(publicKey, message, signature));
        });
    });
    describe("sign", function() {
        it("produces a valid signature", function() {
            var privateKey = new Uint8Array([0xc0, 0x97, 0x24, 0x84, 0x12,
                ...
                0xe8, 0x65]).buffer;
            var actualSignature = axolotlCrypto.sign(privateKey, message);
            assert.ok(axolotlCrypto.verifySignature(publicKey, message, actualSignature));
        });
    });
    describe("hmac", function() {
        it("produces the correct output", function() {
            ...
            return axolotlCrypto.hmac(key, data).then(function(actual) {
    ...
    describe("decrypt", function() {
        it("produces the correct output", function() {
            ...
            return axolotlCrypto.decrypt(key, ciphertext, iv).then(function(actual) {
                assert.ok(areArrayBuffersEqual(expected, actual));
            });
        });
    });
    describe("randomBytes", function() {
        it("returns an ArrayBuffer", function() {
            var bytes = axolotlCrypto.randomBytes(10);
        ...
        it("returns random data", function() {
            var bytes1 = axolotlCrypto.randomBytes(10);
            var bytes2 = axolotlCrypto.randomBytes(10);
